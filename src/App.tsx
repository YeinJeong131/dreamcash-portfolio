...
import dreamcashFoldable from './assets/dreamcash-foldable.jpg'
...
      <a href="#top" className="text-sm font-semibold tracking-tight">YJ<span className="text-[#5B98EE]">.</span></a>
...
      <a href="mailto:bella060131@gmail.com" className="rounded-full border border-white/15 px-4 py-2 text-xs font-medium transition hover:border-[#5B98EE]/50 hover:bg-[#5B98EE] hover:text-black">Let’s talk</a>
...
    <div className="absolute left-[10%] top-28 h-72 w-72 rounded-full bg-[#5B98EE]/10 blur-[110px]" />

    <div className="shell relative flex min-h-[calc(92vh-4rem)] flex-col justify-center py-20">

      <motion.div {...fade} className="max-w-4xl">

        <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-[#5B98EE]/25 bg-[#5B98EE]/[0.08] px-3 py-2 text-[11px] font-medium text-[#76AAEF]">

          <span className="h-1.5 w-1.5 rounded-full bg-[#5B98EE] shadow-[0_0_12px_rgba(91,152,238,.85)]" />
...
          <a href="#dreamcash" className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#5B98EE] to-[#7DB5F5] px-5 py-3 text-sm font-semibold text-black transition hover:from-[#6CA5F0] hover:to-[#91C2F8]">See my Dreamcash study <ArrowDown size={15} className="transition group-hover:translate-y-0.5" /></a>
...
function DeviceConcept() {
  return (
    <motion.div
      {...fade}
      className="mt-12 overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.025]"
    >
      {/* Image */}
      <div className="group relative overflow-hidden bg-[#0a0d0b]">
        {/* Blue glow */}
        <div className="pointer-events-none absolute left-1/2 top-1/2 z-0 h-[65%] w-[65%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#5B98EE]/10 blur-[100px] transition-all duration-700 group-hover:bg-[#5B98EE]/20" />
        ...
        >
          <img
            src={dreamcashFoldable}
            alt="Dreamcash foldable trading interface concept"
            className="block h-auto w-full object-cover transition-transform duration-700"
          />
        </motion.div>

        {/* Small label */}
        <div className="pointer-events-none absolute left-5 top-5 z-20 rounded-full border border-white/15 bg-black/45 px-3 py-1.5 backdrop-blur-md">
          <div className="flex items-center gap-2">
            <motion.span
              ...
              className="h-1.5 w-1.5 rounded-full bg-[#6EA8F5]"
            />
      ...
      {/* Explanation */}
      <div className="grid gap-8 border-t border-white/10 p-6 sm:p-8 md:grid-cols-[1fr_1.35fr] md:p-10">
        <div>
          <p className="eyebrow">
            Designing across devices
          </p>

          <h3 className="mt-3 max-w-md text-2xl font-medium tracking-[-0.03em] text-white sm:text-3xl">
            Adapting the experience,
            <span className="text-white/35"> not just the screen size.</span>
          </h3>
        </div>

        <div className="flex flex-col justify-between">
          <p className="max-w-xl text-sm leading-7 text-white/50">
            I’m interested in how trading products can adapt to different
            devices without losing clarity or functionality. With my background
            across backend development, cloud infrastructure and frontend
            technologies, I’d like to contribute to building experiences that
            connect reliable systems with interactive, device-aware interfaces.
          </p>
...
            <div className="flex items-start justify-between"><span className="text-xs font-mono text-[#5B98EE]/70">{c.index}</span><Sparkles size={16} className="text-white/15 transition group-hover:text-[#5B98EE]/60"/></div>
...
            <motion.div {...fade} className="relative overflow-hidden rounded-[30px] border border-[#5B98EE]/20 bg-gradient-to-br from-[#5B98EE]/[0.10] to-transparent p-7 sm:p-10">

              <p className="text-xs font-medium text-[#76AAEF]">MY EXPLORATION QUESTION</p>
...
              <a href="https://dreamcash.xyz/" target="_blank" rel="noreferrer" className="mt-9 inline-flex items-center gap-2 text-sm font-medium text-[#76AAEF] hover:text-[#9AC3F7]">Visit Dreamcash <ArrowUpRight size={15}/></a>
...
            {p.href && <a href={p.href} target="_blank" rel="noreferrer" className="mt-7 inline-flex items-center gap-2 text-sm text-white/65 transition hover:text-[#76AAEF]">View project <ArrowUpRight size={14}/></a>}
...
            ].map(([a,b,c]) => <motion.div {...fade} key={a} className="rounded-3xl border border-white/[0.07] p-6"><h3 className="text-lg font-medium">{a}</h3><p className="mt-2 text-xs text-[#5B98EE]/65">{b}</p><p className="mt-5 text-sm leading-6 text-white/45">{c}</p></motion.div>)}
...
        <motion.div {...fade} className="relative overflow-hidden rounded-[36px] border border-[#5B98EE]/20 bg-[#5B98EE] p-8 text-black sm:p-12">
